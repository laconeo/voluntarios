...
const RoleDetailModal: React.FC<RoleDetailModalProps> = ({ role, onClose }) => {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center p-4">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto relative z-10 m-4">
        <div className="p-6">
          <div className="flex justify-between items-start">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">{role.name}</h2>
          ...
          <div className="space-y-4 text-gray-700">
            ...
            <p><span className="font-semibold">Nivel de Experiencia Requerido:</span> <span className="capitalize px-2 py-1 bg-blue-100 text-blue-800 rounded-full text-sm">{role.experienceLevel}</span></p>
